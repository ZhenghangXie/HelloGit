...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['alpha148','alpha102','VEMA10','STM','alpha155','LongDebtToAssets']
...
import alpha148,alpha102,alpha155,VEMA10,STM,LongDebtToAssets
for f in ['alpha148','alpha102','alpha155','VEMA10','STM','LongDebtToAssets']:
